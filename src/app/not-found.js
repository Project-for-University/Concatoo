...
export default function Pages() {
    return (
        <div className="text-center pt-52">
            ...
            <Link href={'/'} className="  text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium px-6 py-3 rounded-full text-center me-2 mb-2 ">Go to Homepage</Link>
