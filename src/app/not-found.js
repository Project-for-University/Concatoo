...
export default function Pages() {
    return (
        <div className="text-center pt-52">
            ...
            <Link href={'/'} className="  text-white bg-gradient-to-b from-emerald-300 to-emerald-400 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium px-6 py-3 rounded-full text-center me-2 mb-2 ">Go to Homepage</Link>
