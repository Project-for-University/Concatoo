            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <div class="flex justify-between">
                        ...
                        <p class="text-rose-600"><a>Daftar</a></p>
                    </div>
                    

                    <form id="" class="max-w-md mx-auto" action="/login">

                        <div class="relative z-0 w-full mb-5 group">
                            <label for="email" class="block mb-2 text-sm font-normal text-gray-900 dark:text-white">Phone Number</label>
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <label for="confirm_password" class="block mb-2 text-sm font-normal text-gray-900 dark:text-white">Password</label>
                        ...
                        <button type="submit" class="w-full text-white bg-gradient-to-r from-rose-300 to-rose-600 hover:bg-rose-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-rose-600 dark:hover:bg-rose-700 dark:focus:ring-blue-800">Masuk</button>
