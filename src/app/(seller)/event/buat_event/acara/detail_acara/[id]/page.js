...
function Card({ param }) {
    ...
    useEffect(() => {
        ...
        const fetchAcara = async () => {
            ...
            const response = await fetch(`/event/buat_event/acara/detail_acara/api/read_acara/${param.id}`, {
                method: 'GET'
            });
    ...
    async function DeleteTiket(id) {
        console.log(id);
        const res = await fetch(`/event/buat_event/acara/detail_acara/api/delete_tiket/${id}`, {
            method: 'DELETE',
        })
